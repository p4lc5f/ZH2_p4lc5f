...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\p4lc5f\\Desktop\\gyk3\\ZH2_p4lc5f\\ZH2_p4lc5f\\Database1.mdf;Integrated Security=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Course>(entity =>
        {
            entity.HasKey(e => e.CourseSk).HasName("PK__Course__C92D8C489C468E47");
        ...
        {
            entity.HasKey(e => e.DayId).HasName("PK__Day__BF3DD8251FFF2B4B");
        ...
        {
            entity.HasKey(e => e.EmployementId).HasName("PK__Employem__BFBFF0761382FD23");
        ...
        {
            entity.HasKey(e => e.InstructorSk).HasName("PK__Instruct__9D017A28B28993B7");
        ...
        {
            entity.HasKey(e => e.LessonSk).HasName("PK__Lesson__B08512E2F35EF989");
        ...
        {
            entity.HasKey(e => e.RoomSk).HasName("PK__Room__328616CF24169028");
        ...
        {
            entity.HasKey(e => e.StatusId).HasName("PK__Status__C8EE20433E984C01");
        ...
        {
            entity.HasKey(e => e.TimeId).HasName("PK__Time__E04ED967FC9532EE");
